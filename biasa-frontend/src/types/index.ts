...
export interface DemandeAchat { id: number; numero: string; date_demande: string; service_demandeur: string; poste_fonction: string | null; type_da: TypeDA; nature: NatureDA; motif: MotifDA; urgence: UrgenceDA; statut: StatutDA; justification: string | null; normes_certifications: string | null; date_peremption_min: string | null; fournisseur_suggere: string | null; autres_specs: string | null; lieu_utilisation: string | null; soumise_le: string | null; mise_a_jour_le: string; confirmation_demandeur_le: string | null; confirmation_acheteur_le: string | null; bc_cree_le: string | null; commande_le: string | null; livre_le: string | null; demandeur: Utilisateur; lignes: LigneDA[]; fichiers: FichierDA[]; historique: HistoriqueItem[]; messages: MessageDA[] }
