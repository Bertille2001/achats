    ...
    <div style={{ minHeight: '100vh', background: '#eaf2fb', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 24 }}>
      <div style={{ width: '100%', maxWidth: 400 }}>
        <div style={{ background: '#fff', borderRadius: 14, border: '1px solid rgba(0,0,0,0.06)', boxShadow: '0 4px 24px rgba(0,0,0,0.08)', padding: '32px 28px' }}>
          ...
          {message ? (
            <div style={{ padding: '12px 14px', fontSize: 12.5, borderRadius: 8, color: '#0B3C7A', background: '#eaf2fb', border: '1px solid #dbe9f7', lineHeight: 1.5 }}>
              {message}
            </div>
          ) : (
            <form onSubmit={handleSubmit}>
              <div style={{ marginBottom: 20 }}>
                <label style={{ display: 'block', fontSize: 11.5, fontWeight: 600, color: '#5e6f85', marginBottom: 6, letterSpacing: '0.4px' }}>NOM D'UTILISATEUR</label>
