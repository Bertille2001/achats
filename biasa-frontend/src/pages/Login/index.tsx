  ...
  return (
    <div style={{
      ...
      <div style={{ width: '100%', maxWidth: 400, zIndex: 1 }}>
        <div style={{ background: '#fff', borderRadius: 14, overflow: 'hidden', border: '1px solid rgba(0,0,0,0.06)', boxShadow: '0 4px 24px rgba(0,0,0,0.08)' }}>
          <div style={{ padding: '36px 28px 28px', position: 'relative', overflow: 'hidden' }}>
            ...
            <div style={{ marginBottom: 28, position: 'relative' }}>
              ...
              <div style={{ fontSize: 13.5, color: '#5e6f85', marginBottom: 2 }}>
            ...
            <div style={{ marginBottom: 22 }}>
              ...
              <div style={{ fontSize: 13.5, color: '#8a96a3' }}>Accédez à votre espace de gestion</div>
            </div>
            ...
            <form onSubmit={handleSubmit}>
              <div style={{ marginBottom: 14 }}>
                <label style={{ display: 'block', fontSize: 11.5, fontWeight: 600, color: '#5e6f85', marginBottom: 6, letterSpacing: '0.4px' }}>
                  NOM D'UTILISATEUR
                </label>
                <input
                  type="text"
                  ...
                  style={{ width: '100%', padding: '11px 14px', fontSize: 14.5, border: '1px solid rgba(0,0,0,0.15)', borderRadius: 8, background: '#eaf2fb', color: '#0B3C7A', outline: 'none', boxSizing: 'border-box' as const, fontFamily: 'inherit' }}
        ...
        <div style={{ marginTop: 16, fontSize: 12.5, color: '#8a96a3', textAlign: 'center' }}>
